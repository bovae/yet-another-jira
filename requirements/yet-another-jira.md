...
<thead>
<tr>
<th><p><strong>Mandatory scope: authentication, teams, epics, tickets,
comments, and a draggable Kanban board.</strong></p>
<p><strong>Scrum, sprints, SSO, and advanced project-management features
<u>are explicitly out of scope</u>.</strong></p></th>
</tr>
</thead>
<tbody>
</tbody>
...
| Type | Yes | bug \| feature \| fix | Use exactly these three values. They are classification labels only; no different workflow behavior is required for bug, feature, or fix. |
| State | Yes | new \| ready_for_implementation \| in_progress \| ready_for_acceptance \| done | These are the canonical API values. The UI should display human-readable labels with spaces. The workflow is fixed; no custom states are required. |
...
| Title | Yes | Text | Must be non-empty after trimming. It is intended as short display text, but no mandatory application-level maximum length is specified. |
| Body | Yes | Long text | Must be non-empty. Plain text or Markdown is acceptable; rich-text editing is not required. No mandatory application-level maximum length is specified. |
...
style="width:6.9in;height:3.83333in"
alt="Low-fidelity wireframe of the five-column Kanban board with team selector, filters, and draggable ticket cards." />
<figcaption><p>Wireframe 1 - Kanban board (primary
screen)</p></figcaption>
</figure>

<figure>
<img src="./images/media/image2.png" style="width:6.8in;height:3.825in"
alt="Low-fidelity wireframe showing login, account creation, verification success, and resend verification actions." />
<figcaption><p>Wireframe 2 - Login, sign-up, and email
verification</p></figcaption>
</figure>

<figure>
<img src="./images/media/image3.png" style="width:6.8in;height:3.825in"
alt="Low-fidelity ticket detail and edit wireframe showing ticket metadata, editable fields, comments, and comment creation." />
<figcaption><p>Wireframe 3 - Ticket details, editing, and
comments</p></figcaption>
</figure>

<figure>
<img src="./images/media/image4.png" style="width:6.8in;height:3.825in"
alt="Low-fidelity team management wireframe. Delete is disabled for teams that contain tickets or epics and enabled for an empty team." />
<figcaption><p>Wireframe 4 - Team management</p></figcaption>
</figure>

<figure>
<img src="./images/media/image5.png" style="width:6.8in;height:3.825in"
alt="Low-fidelity epic management wireframe. Delete is disabled for epics referenced by tickets; the epic team is fixed after creation." />
<figcaption><p>Wireframe 5 - Epic management</p></figcaption>
</figure>
