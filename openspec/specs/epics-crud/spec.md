...
## Purpose
CRUD management of epics, which group tickets under a fixed team. All endpoints live under `/api/v1/epics`, require authentication, trim and cap titles, keep an epic's team immutable after creation, and guard deletion against referencing tickets.
