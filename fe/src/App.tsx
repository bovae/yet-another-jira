 ...
 * `/tickets/:id` render the real ticket list and details screens (E14). `/` renders the real Kanban
 * board with team selector, filters, and drag-and-drop (E15). Business routes sit behind
